...
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Paste a YouTube link and save the video or audio file directly to your device."
			},
			{
				name: "theme-color",
				content: "#09090b"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
					...
					toastOptions: { className: "!bg-card !text-foreground !border-0 !shadow-[0_0_0_1px_color-mix(in_oklab,var(--color-foreground)_10%,transparent)]" }
				}),
...
function disposition(filename, attachment) {
...
var Route = createFileRoute("/api/download")({ server: { handlers: {
	GET: handleDownload,
	HEAD: handleDownload
} } });
